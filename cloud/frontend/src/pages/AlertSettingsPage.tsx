...
const Input = ({ label, id, error, ...props }: any) => (
    <div>
        ...
        <input id={id} {...props} className="mt-1 block w-full rounded-md bg-brand-bg2 border-brand-line text-white shadow-sm focus:border-blue-500 focus:ring-brand-primary sm:text-sm" />
