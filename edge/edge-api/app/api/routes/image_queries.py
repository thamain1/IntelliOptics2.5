...
# IntelliOptics SDK imports (optional - for cloud integration)
try:
    ...
    ImageQuery = None
    SDK_AVAILABLE = False
    logging.warning("IntelliOptics SDK not available in image_queries route. Cloud integration disabled.")
