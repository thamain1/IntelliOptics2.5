...
try:
    ...
    # SDK not available at all - create placeholder types
    MODEL_TYPES_AVAILABLE = False
    ROI = dict
    BinaryClassificationResult = dict
    CountingResult = dict
    CountModeConfiguration = dict
    ImageQuery = dict
    ImageQueryTypeEnum = None
    Label = dict
    ModeEnum = None
    MultiClassificationResult = dict
    MultiClassModeConfiguration = dict
    ResultTypeEnum = None
    Source = dict
    logging.warning("IntelliOptics SDK model types not available. Using placeholder types.")
