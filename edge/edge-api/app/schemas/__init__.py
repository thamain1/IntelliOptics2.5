...
# Kubernetes management is optional (only needed when DEPLOY_DETECTOR_LEVEL_INFERENCE=1)
try:
    from app.core.kubernetes_management import InferenceDeploymentManager
    KUBERNETES_AVAILABLE = True
except ImportError:
    # Placeholder class when Kubernetes is not available
    class InferenceDeploymentManager:
        pass
    KUBERNETES_AVAILABLE = False
    logging.warning("Kubernetes management not available. Dynamic inference deployment disabled.")
