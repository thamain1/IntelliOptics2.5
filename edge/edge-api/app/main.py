...
from app.api.routes.open_vocab import router as open_vocab_router
from app.api.routes.vehicle_id import router as vehicle_id_router
from app.api.routes.forensic_search import router as forensic_search_router

app = FastAPI(title="edge-endpoint")
app.include_router(router=api_router, prefix=API_BASE_PATH)
app.include_router(router=ping_router)
app.include_router(router=health_router)
app.include_router(router=open_vocab_router)
app.include_router(router=vehicle_id_router)
app.include_router(router=forensic_search_router)
